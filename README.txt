...
Limitations
-----------
While wave2tia can create some neat conversions, the FFT analysis approach is 
...
wave2tia tries to make the best of this situation by using a sliding window 
